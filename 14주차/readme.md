...
| 항목         | 설명 |
|--------------|------|
| 🎯 경진대회   | 기업·기관이 문제 제시, 참가자들이 모델 개발 후 경쟁 |
| 📊 데이터셋   | 다양한 공개 데이터셋 무료 제공 (CSV, 이미지 등) |
| 🧑‍💻 노트북   | 웹 기반 Python 코드 실행 환경 (Jupyter 기반) |
| 📚 튜토리얼   | Kaggle Learn을 통해 머신러닝·딥러닝 코스 제공 |
| 👥 커뮤니티   | 코드 공유, 토론, 실전 사례 학습 가능 |
...
- 수업 과제용 미니 프로젝트 설계
- 최신 AI 모델과 접근법 학습
- PBL(Project-Based Learning) 기반 수업 구성
